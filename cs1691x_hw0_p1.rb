...
# sum
fail 'sum([]) != 0' unless sum([]) == 0
fail 'sum([1,2,3,4]) != 10' unless sum([1, 2, 3, 4]) == 10

# max_2_sum
fail 'max_2_sum([]) != 0' unless max_2_sum([]) == 0
fail 'max_2_sum([0]) != 0' unless max_2_sum([0]) == 0
fail 'max_2_sum([15]) != 15' unless max_2_sum([15]) == 15
fail 'max_2_sum([1,2,3,4]) != 7' unless max_2_sum([1, 2, 3, 4]) == 7
fail 'max_2_sum([1,4,3,2]) != 7' unless max_2_sum([1, 4, 3, 2]) == 7

# sum_to_n?
fail 'sum_to_n([], 3) != false' unless sum_to_n?([], 3) == false
fail 'sum_to_n([1], 3) != false' unless sum_to_n?([1], 3) == false
fail 'sum_to_n([1,2,3,4], 3) != true' unless sum_to_n?([1, 2, 3, 4], 3) == true
